...
public:
	...
	float crop_residue[10][40][8], crop_yield[10][40][8], rate_reproduc[10][40][8], Psn_efficiency[10][40][8], Psn_max[10][40][8];
	float TreeAge[10][40][8], TreeCurrentAge[10][40][8], TreeLeafMax[10][40][8], TreeLeafMin[10][40][8];
	...
	int PerennialCrop[10][40][8], Transplant[10][40][8];
	...
	float GrainFill[10][40][8];
	float LAImax[10][40][8];
	float FrostKill[10][40][8];
	float AlfCHRMX[10][40][8];
	float ALFCDRMX[10][40][8];
	float ALFCTMX[10][40][8];
	float Root1[10][40][8];
	float Root2[10][40][8];
	float AGResp1[10][40][8];
	float AGResp2[10][40][8];
	float cropGRate[10][40][8];
	float cropTime[10][40][8];
	float RUEHI[10][40][8];
	float DelayP[10][40][8];
	float ALFPDFMX[10][40][8];
	int	  RootShape[10][40][8];
	//theo kext1,kext2,cmaxh;
...
// Dialog Data
	...
	float m_AGResp1;
	float m_AGResp2;
	float m_cropGRate,m_cropTime,m_RUEHI,m_DelayP;
