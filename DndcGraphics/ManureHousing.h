...
// Dialog Data
	...
	CComboBox	m_FeedAdditive;//new control
	CComboBox	m_SolidLiquidSepa;
	...
	int		m_FeedlotYear;
	float	m_FlushWater;
	float  m_DryMatterFraction;
	float m_DaysInMilk;
	float m_BodyWeight;
	float m_MilkProtein;
	float m_FeedAdditiveRate;
	int m_EmpiricalModel;
	//int m_EmpiricalModel1;
...
protected:
	...
	afx_msg void OnKillfocusVentRate();
	afx_msg void OnKillfocusSolidLiquidSepa();	
	afx_msg void OnEmpiricalModel();
	
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
//public:
 	   
	//afx_msg void OnBnClickedEmpiricalmodel();
