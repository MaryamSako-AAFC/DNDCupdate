...
public:
	...
	char  sitename[255];
	char  Regionname[255];
//This defines all the IData handlers for DNDC GUI	
	float latitude;
	float longitude;
    long  totalday;
    int   years;
	...
	int WaterYr;
    	float DrainDepth;//added new parameters for tile drainage and misc
	float DrainSpace;
float DrainRad;
float DrainBed;
float keDrain;
...
float Factor5;
float Factor6;
int Factor7;//autoHarvest
int AutoPlant;//autoPlant
float Factor8;
float Factor9;
float Factor10;
float Factor13;
...
int TileOption;
	...
	CString SpinUpFileName;
	CString OBSYieldFileName;
	CString CO2FileName;
    float Soil_pH;
	float Flood_pH;
...
//    char  PsisatNote[30];
	...
	float  db_TreeCurrentAge[20][20][5],  db_TreeLeafMax[20][20][5],  db_TreeLeafMin[20][20][5];
	...
	//had to increase stack size in Linker to accomodate these extra parameters for root and growth equations
	float db_Root1[20][20][5];
	float db_Root2[20][20][5], db_VE[20][20][5], db_V1[20][20][5], db_VT[20][20][5];
	float db_R1[20][20][5], db_R3[20][20][5], db_R5[20][20][5], db_R7[20][20][5], db_R8[20][20][5];
	float db_PVE[20][20][5], db_PV1[20][20][5], db_PVT[20][20][5], db_PR1[20][20][5], db_PR3[20][20][5], db_PR5[20][20][5], db_PR7[20][20][5], db_PR8[20][20][5];
	float db_Kext1[20][20][5], db_Kext2[20][20][5], db_cropHeight[20][20][5];//Theo db_cropHeight,db_Kext2,db_Kext1
	float db_AGResp1[20][20][5];
	float db_AGResp2[20][20][5];
	float db_cropTime[20][20][5];
	float db_cropGRate[20][20][5];
	float db_RUEHI[20][20][5];
	float db_DelayP[20][20][5];
...
public:
	...
	//float PsnEfficiency;
	//float PsnMax;
	float TreeAge, TreeCurrentAge, TreeLeafMax, TreeLeafMin;//InitialBiomass;
...
public:
	...
	float TreeAge, TreeCurrentAge, TreeLeafMax, TreeLeafMin, GrowthReproductive, PsnEfficiency,PsnMax;
	float Grain, Leaf, Straw, Root;    
	...
	float ShootResp1;
	float ShootResp2;
	float kExt1, kExt2, cropMH;
	float cropGrate, croptime, RUEHi, delayp;
};
